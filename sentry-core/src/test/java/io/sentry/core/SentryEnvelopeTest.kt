...
class SentryEnvelopeTest {
    ...
    fun `deserialize sample envelope with event and two attachments`() {
        ...
        assertEquals(SentryEnvelopeItemType.Event, firstItem.header.type)
        ...
        assertEquals(SentryEnvelopeItemType.Attachment, secondItem.header.type)
        ...
        assertEquals(SentryEnvelopeItemType.Attachment, thirdItem.header.type)
