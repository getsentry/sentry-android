...
import io.sentry.serialization.internal.$Gson$Preconditions;
import io.sentry.serialization.internal.Excluder;
import io.sentry.serialization.internal.bind.TreeTypeAdapter;
...
import static io.sentry.serialization.Gson.DEFAULT_COMPLEX_MAP_KEYS;
import static io.sentry.serialization.Gson.DEFAULT_ESCAPE_HTML;
import static io.sentry.serialization.Gson.DEFAULT_JSON_NON_EXECUTABLE;
import static io.sentry.serialization.Gson.DEFAULT_LENIENT;
import static io.sentry.serialization.Gson.DEFAULT_PRETTY_PRINT;
import static io.sentry.serialization.Gson.DEFAULT_SERIALIZE_NULLS;
import static io.sentry.serialization.Gson.DEFAULT_SPECIALIZE_FLOAT_VALUES;
...
public final class GsonBuilder {
   ...
   * that do not have the {@link io.sentry.serialization.annotations.Expose} annotation.
   *
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   */
